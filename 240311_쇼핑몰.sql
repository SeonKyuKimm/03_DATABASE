...
INSERT INTO ORDERS VALUES(134, 1, 'Y', TO_DATE('2022-12-25') );
INSERT INTO ORDERS VALUES(499, 1, 'Y', TO_DATE('2020-01-03') );
...
SELECT ORDER_ID, PRODUCT_NAME, QUANTITY, PRICE, SUM(PRICE)
FROM CUSTOMERS
JOIN ORDERS USING(CUSTOMER_ID)
...
WHERE NAME = '유관순'
GROUP BY ORDER_ID, PRODUCT_NAME, QUANTITY, PRICE;
