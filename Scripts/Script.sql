...
-- 3 . "국어국문학과" 에 다니는 여학생 중 현재 휴학중인 여학생을 찾아달라는 요청이 들어왔다 ㄴㄱ인가?
-- (국문학과의 '학과코드'를 학과테이블 을 조회해서 찾아내도록 하자 )
...
--'휴학한 사람들은 제외'한 재학중인 학생들의 학번, 이름 ,주민번호를 출력하는 구문
